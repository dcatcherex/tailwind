  ...
  return (
    <div className="">
      ...
      <div className=" max-w-[1400px] mx-auto flex">
        ...
        {/* control */}
        <div className="m-4 p-4 min-w-[30%] border-2 rounded-lg border-dimviolet justify-items-start">
          ...
          <div className="flex flex-col">
            ...
            <div className="w-full mb-3">
              ...
              <div className="flex flex-col gap-y-2">
                <div className="min-h-[60px] flex items-center gap-x-2 bg-white rounded-md p-2 hover:ring-2 ring-dimviolet cursor-pointer">
                  {/* <input type="checkbox" className="rounded-md w-5 h-5" /> */}
                  <p className="w-[300px]">แบบทดสอบบุคลิกภาพ</p>
                  <input
                    type="range"
                    className="w-full rounded-sm w-5 h-5"
                    min="0"
                ...
                <div className="min-h-[60px] flex items-center gap-x-2 bg-white rounded-md p-2 hover:ring-2 ring-dimviolet cursor-pointer">
                  {/* <input type="checkbox" className="rounded-md w-5 h-5" /> */}
                  <p className="w-[300px]">แบบทดสอบความถนัดทางอาชีพ</p>
                  <input
                    type="range"
                    className="w-full rounded-sm w-5 h-5"
                    min="0"
