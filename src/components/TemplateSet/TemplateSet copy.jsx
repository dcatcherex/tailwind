  ...
  return (
    <div>
      ...
      <div className="flex justify-center pt-4">
        <button className="btn px-4 py-1 min-w-[70px] rounded-full" onClick={()=> setFilterValue("")}>All</button>
        ...
        <button className="btn px-4 py-1 min-w-[70px] rounded-full" onClick={()=> setFilterValue("social")}>Education</button>
      </div>
