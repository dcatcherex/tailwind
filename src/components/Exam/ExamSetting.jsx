...
const ExamSetting = () => {
  ...
  return (
    <div className="min-h-screen px-4 py-2 text-lg max-w-[800px] mx-auto">
      ...
      <div className="flex gap-4">
        ...
        <div className="hidden sm:block min-w-[20%] border-2 border-dimviolet rounded-lg p-4 mt-8">
          <div className="text-darkviolet font-semibold mt-4" >ตั้งค่ากระบวนการสอบ</div>
          <div className="flex flex-col gap-y-2">
            <div className="flex gap-4 items-center">
              <SwitchComponent />
              <div>สุ่มลำดับข้อสอบ</div>
            </div>
            <div className="flex gap-4 items-center">
              <SwitchComponent />
              <div>สุ่มลำดับคำตอบ</div>
            </div>

            <div className="flex gap-4 items-center">
              <SwitchComponent />
              <div>ตอบแล้วตอบเลย</div>
            </div>
            <h4 className="text-darkviolet font-semibold mt-4">ตั้งค่า Personalized Quiz</h4>
            <div className="flex flex-col gap-y-2">
              <div className="flex gap-4 items-center">
                <SwitchComponent />
                <div>ใช้คำถามใกล้เคียง</div>
              </div>
              <div className="flex gap-4 items-center">
                <SwitchComponent />
                <div>ใช้คำถามเฉพาะบุคคล</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <Link
        to={"/exammonitor"}
        className="inline-flex gap-x-2 justify-center mt-8 mb-8 btn text-lg w-full bg-dimviolet "
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
